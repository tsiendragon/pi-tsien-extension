...
import { registerDashboardFeatureBridge } from "pi-tsien-shared/src/lib/dashboard-bridge.ts";
...
} from "pi-tsien-shared/src/lib/background-commands/tools.ts";
import type { BackgroundTaskSnapshot } from "pi-tsien-shared/src/lib/background-commands/types.ts";
...
} from "pi-tsien-shared/src/lib/command-ui/pre-powerline-client.ts";
import { formatElapsedDuration, RunningCommandsWidget } from "pi-tsien-shared/src/lib/command-ui/running-commands-widget.ts";
